...
#define TRANSITION_ROW_WITH_OFFSET(N) front::row<state_tpl<N, Offset>, state_transition_event<N + Offset>, state_tpl<(N + 1) % 25, Offset>, state_transition_action<N + Offset>, guard<N + Offset>>
...
#define X(N) \
        ...
        FOR_RANGE_25
#undef X
    , front::row<state_tpl<0, Offset>, enter_sub_fsm_event, sub_fsm, front::none, front::none>
    , front::row<sub_fsm, exit_sub_fsm_event, state_tpl<0, Offset>, front::none, front::none>
    >;
