...
using fsm2 = msm::backmp11::state_machine<fsm_<PROBLEM_SIZE/2>, config>;
using fsm1 = msm::backmp11::state_machine<fsm_<PROBLEM_SIZE/3, fsm2>, config>;
using fsm0 = msm::backmp11::state_machine<fsm_<0, fsm1>, config>;
